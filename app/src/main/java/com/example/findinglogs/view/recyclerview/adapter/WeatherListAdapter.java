    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void holdWeather(Weather weather, Context context) {
            switch (weather.getWeather().get(0).getIcon()){
                case "01d":
                    cardView.setCardBackgroundColor(context.getColor(R.color.weather_clear_sky1));
                    break;
                case "01n":
                    cardView.setCardBackgroundColor(context.getColor(R.color.weather_clear_sky_dark1));
                    break;
                case "02d":
                    cardView.setCardBackgroundColor(context.getColor(R.color.weather_cloudy2));
                    break;
                case "02n":
                    cardView.setCardBackgroundColor(context.getColor(R.color.weather_cloudy_dark2));
                    break;
                case "03d":
                    cardView.setCardBackgroundColor(context.getColor(R.color.weather_few_clouds3));
                    break;
                case "03n":
                    cardView.setCardBackgroundColor(context.getColor(R.color.weather_few_clouds_dark3));
                    break;
                case "04d":
                    cardView.setCardBackgroundColor(context.getColor(R.color.weather_scattered_clouds4));
                    break;
                case "04n":
                    cardView.setCardBackgroundColor(context.getColor(R.color.weather_scattered_clouds_dark4));
                    break;
                case "09d":
                    cardView.setCardBackgroundColor(context.getColor(R.color.weather_heavy_rain09));
                    break;
                case "09n":
                    cardView.setCardBackgroundColor(context.getColor(R.color.weather_heavy_rain_dark09));
                    break;
                case "10d":
                    cardView.setCardBackgroundColor(context.getColor(R.color.weather_light_rain10));
                    break;
                case "10n":
                    cardView.setCardBackgroundColor(context.getColor(R.color.weather_light_rain_dark10));
                    break;
                case "11d":
                    cardView.setCardBackgroundColor(context.getColor(R.color.weather_thunderstorm11));
                    break;
                case "11n":
                    cardView.setCardBackgroundColor(context.getColor(R.color.weather_thunderstorm_dark11));
                    break;
                case "50d":
                    cardView.setCardBackgroundColor(context.getColor(R.color.weather_fog50));
                    break;
                case "50n":
                    cardView.setCardBackgroundColor(context.getColor(R.color.weather_fog_dark50));
                    break;
                default:
